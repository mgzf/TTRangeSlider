...
/**
 *  song  是否支持交叉滑动   NO:不支持  YES:支持  默认为NO
 */
@property (nonatomic, assign) BOOL isEnabledIntersect;
...
@property (nonatomic) BOOL displayMaxMinValue;

@property (nonatomic) BOOL hiddenMaxMinLabel;
